...
import com.baiyz.www.lib.dao.dbconnectionpool.Config;
import com.baiyz.www.lib.dao.dbconnectionpool.Config.Server;
import com.baiyz.www.lib.dao.dbconnectionpool.ConnectionPool;
import com.baiyz.www.lib.dao.dbconnectionpool.DBConfig;
import com.baiyz.www.lib.dao.dbconnectionpool.SaveNode;
import com.baiyz.www.lib.log.Logger;
...
public class DistributedDBHelper {
	...
	public DistributedDBHelper(int tableCount, String configPath) throws Exception {
		Logger.info("dbconfig path:" + configPath);
	...
	final public DBConfig createDBConfig(String connetionURL, String driversClass, String userName, String passWord, int minPoolSize, int maxPoolSize, int idleTimeout, Boolean autoShrink) {
		...
		config.setConnetionUrl(connetionURL);
