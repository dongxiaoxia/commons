...
/**
 * Created by 01don on 2016/11/16.
 */
public class RegexCheckUtils {
    ...
    public final static boolean isUrl(String str) {
        return RegexUtils.checkMatch(str, "^http://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?$");
    }
    ...
    public final static boolean isPwd(String str) {
        return RegexUtils.checkMatch(str, "^[a-zA-Z]\\w{6,12}$");
    }
    ...
    public final static boolean stringCheck(String str) {
        return RegexUtils.checkMatch(str, "^[a-zA-Z0-9\u4e00-\u9fa5-_]+$");
    }
    ...
    public final static boolean isEmail(String str) {
        return RegexUtils.checkMatch(str, "^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$");
    }
    ...
    public final static boolean isInteger(String str) {
        return RegexUtils.checkMatch(str, "^[+]?\\d+$");
    }
    ...
    public final static boolean isDigits(String str) {
        return RegexUtils.checkMatch(str, "^[0-9]*$");
    }
    ...
    public final static boolean isFloat(String str) {
        return RegexUtils.checkMatch(str, "^[-\\+]?\\d+(\\.\\d+)?$");
    }
    ...
    public final static boolean isPhone(String text) {
        return RegexUtils.checkMatch(text, "^(\\d{3,4}-?)?\\d{7,9}$");
    }
    ...
    public final static boolean isMobile(String text) {
        ...
        return RegexUtils.checkMatch(text, "^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\\d{8})$");
    }
    ...
    public final static boolean isIdCardNo(String text) {
        return RegexUtils.checkMatch(text, "^(\\d{6})()?(\\d{4})(\\d{2})(\\d{2})(\\d{3})(\\w)$");
    }
    ...
    public final static boolean isZipCode(String text) {
        return RegexUtils.checkMatch(text, "^[0-9]{6}$");
    }

    /**
     * 日期验证，判断：YYYY/MM/DD| YY/MM/DD
     *
     * @param text
     * @return
     * @author jiqinlin
    ...
    public final static boolean isDate(String text) {
        return RegexUtils.checkMatch(text, "^(^(\\d{4}|\\d{2})(\\-|\\/|\\.)\\d{1,2}\\3\\d{1,2}$)|(^\\d{4}年\\d{1,2}月\\d{1,2}日$)$");
    }
    ...
    public final static boolean isRightfulString(String text) {
        return RegexUtils.checkMatch(text, "^[A-Za-z0-9_-]+$");
    }
    ...
    public final static boolean isEnglish(String text) {
        return RegexUtils.checkMatch(text, "^[A-Za-z]+$");
    }
    ...
    public final static boolean isChineseChar(String text) {
        return RegexUtils.checkMatch(text, "^[\u0391-\uFFE5]+$");
    }
    ...
    public final static boolean isChinese(String text) {
        return RegexUtils.checkMatch(text, "^[\u4e00-\u9fa5]+$");
    }
...
//    匹配网址URL的正则表达式：^http://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?$
    ...
    public static void main(String[] args) {
        System.out.println("过滤中英文特殊字符: " + RegexCheckUtils.stringFilter("中国~~!#$%%."));
        System.out.println("是否包含中英文特殊字符: " + RegexCheckUtils.isContainsSpecialChar("12?%^&*"));
        System.out.println("过滤html代码: " + RegexCheckUtils.htmlFilter("<JAVASCRIPT>12</JAVASCRIPT>DDDDD"));
        System.out.println("判断中文字符: " + RegexCheckUtils.isChineseChar("中国！"));
        System.out.println("匹配汉字: " + RegexCheckUtils.isChinese("中国!"));
        System.out.println("判断英文字符: " + RegexCheckUtils.isEnglish("abc!"));
        System.out.println("判断合法字符: " + RegexCheckUtils.isRightfulString("abc_-11AAA"));
        System.out.println("邮政编码验证: " + RegexCheckUtils.isZipCode("162406"));
        System.out.println("身份证号码验证: " + RegexCheckUtils.isIdCardNo("35052419880210133e"));
        System.out.println("手机号码验证: " + RegexCheckUtils.isMobile("18918611111"));
        System.out.println("电话号码验证: " + RegexCheckUtils.isPhone("8889333"));
        System.out.println("电话号码验证: " + RegexCheckUtils.isNumeric("888.9333"));
        System.out.println("匹配密码: " + RegexCheckUtils.isPwd("d888d_ddddd"));
        System.out.println("匹配密码: " + RegexCheckUtils.isUrl("http://baidu.com"));
        System.out.println("验证字符: " + RegexCheckUtils.stringCheck("中文aabc001_-"));
